...
import 'package:agrotech_hackat/widgets/sign_up_page1.dart';
import 'package:agrotech_hackat/widgets/sign_up_page4.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../size_config.dart';
import '../widgets/sign_up_page2.dart';
import '../widgets/sign_up_page3.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        children: [
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "$_index of 4",
                  style: TextStyle(
                      fontSize: h(16, context), fontWeight: FontWeight.bold),
                ),
              ),
            ],
          ),
          Padding(
            padding: EdgeInsets.only(left: w(24, context), top: h(24, context)),
            child: Text(
              _texts[_index - 1]['name'],
              style: TextStyle(
                  fontSize: h(16, context), fontWeight: FontWeight.w600),
            ),
          ),
          Padding(
            padding: EdgeInsets.only(left: w(24, context), top: h(24, context)),
          ...
          _index==3? Padding(
            padding:  EdgeInsets.only(left: w(24, context), top: h(4, context)),
            child: Text(
